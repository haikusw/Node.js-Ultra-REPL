...
function Dict(values){
  ...
  dictData.set(this, Object.create(null));
  if (values) {
...
Dict.prototype = {
  ...
  data: function data(key, value){
    ...
    if (typeof value === 'undefined') {
      return typeof key === 'undefined' ? store : store[key];
    }
    store[key] = value;
  },
  ...
  toArray: function toArray(){ return this.keys.map(function(k){ return Pair(k, this[k]); }, this); },
