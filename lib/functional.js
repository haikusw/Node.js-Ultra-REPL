...
function curry(f,b){
  ...
  var params = fill(f.length - a.length+2, uletter);
  var code = [ '1&&function '+f.name+'_('+params+'){', ' var A=arguments', ' switch(A.length){',
               '  default: return f.apply(b'+',P.concat(slice.call(A)))',
