var hidden = require('./object-utils').lazyProperty;
...
Grid.prototype = {
  ...
  toString: function toString(){
    ...
    widest(this).forEach(function(width, i){
      if (i < startlength) {
...
function dense(s){ return new Array(s).join(' ').split(' ') }
function pluck(p){
  return Array.isArray(p) ? function(o){ return p.map(function(s){ return o[s] }) }
                          : function(o){ return o[p] };
}
