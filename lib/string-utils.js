...
scolor.context = { colors: process.stdout._type === 'tty' };
...
module.exports = {
  ...
  attachTo: function attachTo(obj){
    Object.defineProperties(obj, {
      ...
      stripAnsi: __(function stripAnsi(){
...
// function Columns(array, gutter){
//   var columns = [];
//   columns.__proto__ = Columns.prototype;
//   array.forEach(function(row){
//     columns.push(Row(row, columns));
//   });
//   if (typeof gutter === 'number') {
//     gutter = ' '.repeat(gutter);
//   }
//   return Object.defineProperty(columns, 'gutter', { value: gutter || '', writable: true });
// }

// Columns.prototype = {
//   __proto__: Array.prototype,
//   toString: function toString(){
//     this.widths = widest(this);
//     return this.join('\n');
//   },
//   push: function push(){
...
//   return Object.defineProperty(row, 'parent', { value: parent, writable: true });
// }

// Row.prototype = {
//   __proto__: Array.prototype,
//   toString: function toString(){
//     if (this.parent && this.parent.widths) {
//       var array = this.map(function(item, i){
//         return item.pad(this[i]);
//       }, this.parent.widths);
//     }
...
// function widest(array){
//   if (typeof array[0] === 'string') array = [array];
//   return array.reduce(function(widths, row){
//     return widths.map(function(width, i){
//       return width > String(row[i]).length ? width : String(row[i]).length;
//     });
//   }, Array(array[0].length).join(' ').split(' '));
// }
